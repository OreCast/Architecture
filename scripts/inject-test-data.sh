...
if [ "`hostname -s`" == "lnx15" ]; then
    url="http://orecast-s3-dev.classe.cornell.edu:8330"
fi
curl -X POST -H "Content-type: application/json" \
    -d '{"name":"cornell", "description": "Cornell waste mineral site", "url": $url, "access_key": "79c936397f8846f67026104fc175908d29f4ff0f61d1e7da4102f46b2db499f3c4acf1e37c3d", "access_secret": "79c936397f8846f67026104fc175908d29f4ff0f61d1e7da4102f46b2db499f3c4acf1e37c3d", "use_ssl": false, "endpoint": "localhost:8330"}' \
